...
ptCloud = pcread('data/results_map_trajectory/results_2025_04_07-12_00_34/lidar/map_2025_04_07-12_00_34.pcd');

% --- Step 2: Load the trajectory ---
% Read the CSV into a table
T = readtable('data/results_map_trajectory/results_2025_04_07-12_00_34/lidar/trajectory_2025_04_07-12_00_34.csv');
...
Q = [survey_position(3,:); survey_position(4,:); survey_position(11,:); survey_position(10,:); survey_position(9,:)];       % target (after some R & t)
P = [0.34157 -10.1081 1.9675; -1.5063 -10.3174 1.3983; -4.3383 -29.1034 9.0318; -5.6864 -29.1488 8.6777; -1.5096 -10.5344 1.5054];       % source 
...
writetable(T, 'data/results_map_trajectory/results_2025_04_07-12_00_34/aligned_trajectory_2025_04_07-12_00_34.csv');
pcwrite(ptCloudTransformed, 'data/results_map_trajectory/results_2025_04_07-12_00_34/aligned_map_2025_04_07-12_00_34.ply', 'Encoding', 'ascii');
