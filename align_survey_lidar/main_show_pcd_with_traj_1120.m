...
ptCloud = pcread('data/results_map_trajectory/results_2025_04_07-11_20_03/lidar/map_2025_04_07-11_20_03.pcd');

% --- Step 2: Load the trajectory ---
% Read the CSV into a table
T = readtable('data/results_map_trajectory/results_2025_04_07-11_20_03/lidar/trajectory_2025_04_07-11_20_03.csv');
...
P = [-3.7157 7.9847 0.1728; -1.9446 8.6874 0.40741; -11.2734 27.1491 4.3589; -10.0313 27.5776 4.5338];       % source 
...
writetable(T, 'data/results_map_trajectory/results_2025_04_07-11_20_03/aligned_trajectory_2025_04_07-11_20_03.csv');
pcwrite(ptCloudTransformed, 'data/results_map_trajectory/results_2025_04_07-11_20_03/aligned_map_2025_04_07-11_20_03.ply', 'Encoding', 'ascii');
